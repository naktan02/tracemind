...
| `server_update_policy/` | `server_update_policy` | server가 client delta/update payload를 어떤 형식과 의미로 해석할지 |
...
| `local_ssl_policy/` | `local_ssl_policy` | client local pseudo-label/consistency objective identity |
