...
from scripts.support.artifacts.run_artifacts import build_run_dir  # noqa: E402
from scripts.workflows.prototype_pack.io import load_jsonl  # noqa: E402
...
@hydra.main(
    version_base=None,
    config_path="../../../conf",
    config_name="entrypoints/prototype_pack/evaluate_prototype_pack",
)
