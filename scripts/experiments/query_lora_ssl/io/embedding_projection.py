...
def write_query_lora_projection_artifacts(
    *,
    ...
    for dataset_name, dataloader in eval_loaders.items():
        ...
        points_path = paths.projections_dir / f"{safe_name}.projection.jsonl"
        figure_path = paths.projections_dir / f"{safe_name}.projection.png"
    ...
    manifest_path = paths.projections_dir / "projection_manifest.json"
