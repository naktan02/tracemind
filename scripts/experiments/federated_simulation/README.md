...
- 현재 `10% labeled / 90% unlabeled`, `3 seeds`, macro-F1/worst-client/ECE
  기준은 paper protocol metadata로 고정됐지만, 이 v1 simulation runner가 아직
  그 전체 report schema를 모두 산출하지는 않는다.
