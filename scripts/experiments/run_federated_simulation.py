...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="hash_debug",
        help="Embedding backend used for the simulation.",
    )
    parser.add_argument(
        "--hash-dim",
        type=int,
        default=256,
        help="Embedding dimension when backend=hash_debug.",
    )
    parser.add_argument(
        "--model-id",
        default="tracemind-embed-sim",
        help="Model identifier recorded in simulation artifacts.",
    )
    parser.add_argument(
        "--training-scope",
    ...
    *,
    ...
    for round_index in range(1, rounds + 1):
        ...
        for shard in dataset_split.client_shards:
            ...
            local_result = local_training_service.run_task(
