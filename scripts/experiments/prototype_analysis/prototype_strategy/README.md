...
```bash
python -m scripts.experiments.prototype_analysis.prototype_strategy_experiment \
...
```bash
python -m scripts.experiments.prototype_analysis.prototype_threshold_sweep \
