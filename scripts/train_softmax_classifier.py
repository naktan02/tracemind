...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Embedding backend used for classifier training.",
    )
    parser.add_argument(
        "--embedding-model-id",
    ...
    parser.add_argument(
        "--device",
        default="auto",
        help="Execution device for both embedding and classifier training.",
    )
    parser.add_argument(
        "--cache-dir",
        type=Path,
...
def main() -> None:
    ...
    training_device = resolve_runtime_device(args.device)
    classifier_version = (
