...
class LocalTrainingService:
    ...
    def run_task(
        ...
        *,
        ...
        if training_task.model_revision != model_manifest.model_revision:
        ...
        scored_events = [example.scored_event for example in training_examples]
        ...
        minimum_examples = training_task.min_required_examples or 1
        ...
        update_id = f"update_{training_task.round_id}_{uuid4().hex[:12]}"
