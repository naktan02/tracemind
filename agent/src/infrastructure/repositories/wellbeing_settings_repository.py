...
INSERT INTO wellbeing_settings
    (record_id, default_timeseries_range, parent_session_minutes,
     parent_lock_minutes, parent_max_attempts)
VALUES (1, ?, ?, ?, ?)
...
_SELECT_SQL = """
SELECT default_timeseries_range, parent_session_minutes,
       parent_lock_minutes, parent_max_attempts
