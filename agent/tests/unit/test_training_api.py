...
def test_run_current_task_returns_unsupported_runtime_for_fixmatch_live_path() -> None:
    repo = MagicMock()
    ...
    assert response.round_id == "round_fixmatch"
    assert response.task_id == "task_fixmatch"
