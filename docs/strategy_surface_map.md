...
| Aggregation backend | `fedavg` | `round_runtime.aggregation_backend_name` | `methods/federated/aggregation/fedavg/*` + `methods/adaptation/<family>/fedavg_projection.py` + main_server generic aggregation executor | 활성 runtime |
