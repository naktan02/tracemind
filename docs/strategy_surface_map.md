...
| Aggregation backend | `fedavg` | `round_runtime.aggregation_backend_name` | `methods/federated/aggregation/fedavg/*`, main_server `aggregation/fedavg.py` adapter | 활성 runtime |
