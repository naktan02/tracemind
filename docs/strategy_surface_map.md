...
| Child Support Response Policy | `scope_redirect`, `supportive_reflection`, `check_in`, `safety_check`, `urgent_safety` | `ChildSupportResponsePolicy` | code default | public config 없음 | 활성 runtime |
