...
| captured text local boundary | `agent/src/contracts/captured_text_contracts.py`, `agent/src/features/captured_text/storage/repository.py` |
| training source usage ledger | `agent/src/infrastructure/repositories/training_usage_ledger_repository.py` |
| child-support local boundary | `agent/src/contracts/child_support_contracts.py`, `agent/src/features/wellbeing/child_support/service.py` |
