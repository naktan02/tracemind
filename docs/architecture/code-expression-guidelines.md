...
- `scripts/support/query_ssl_text_encoder/runtime_context.py`: Hydra config, model, tokenizer,
...
- `scripts/experiments/fl_ssl/federated_simulation/io/`: direct file 20개로 넓다. IO
  ...
  재사용한다.
- `scripts/support/query_ssl_text_encoder/runtime_context.py`: Hydra config, model,
