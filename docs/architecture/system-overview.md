...
| adapter-family FedAvg projection/materialization | `methods/adaptation/<family>/aggregation/*` 또는 `methods/classification/<family>/aggregation/*`, 필요 시 `server_preflight.py` |
