...
| 3 | `pseudo_label_selection` | 부분 완료 | 3 | public surface에서는 내렸고, 남은 bootstrap/replay helper 입력과 `pseudo_label_inputs.py` owner를 더 줄인다. |
...
실행 묶음은 남은 `1, 3` 중앙 SSL workflow 강등을 먼저 끝내고, 그 뒤 README/compose/
