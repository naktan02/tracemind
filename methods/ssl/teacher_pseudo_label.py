"""Teacher prediction 기반 pseudo-label export 의미를 소유한다."""
...
def resolve_pseudo_label_algorithm(
    ...
    """Hydra config에서 pseudo-label selection preset을 해석한다."""
...
class TeacherPseudoLabelBuilder:
    ...
    def build_export(
        ...
        *,
        ...
        pseudo_label_algorithm: ResolvedPseudoLabelAlgorithm,
