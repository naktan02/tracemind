...
- `server_update_compatibility.py`: update payload의 model/base revision/scope,
  backbone, LoRA config, label schema가 active state와 맞는지 확인하는
  family-local preflight
