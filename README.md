...
3. [plan.md](plan.md)
4. [docs/project_execution_plan.md](docs/project_execution_plan.md)
5. [shared/src/contracts/README.md](shared/src/contracts/README.md)
...
- `apps/`
  - 개발자 실험 웹, future youth/guardian UI shell
- `tests/`
...
- round orchestration 경로: [main_server/src/services/rounds/README.md](main_server/src/services/rounds/README.md)
