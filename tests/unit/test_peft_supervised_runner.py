...
def test_run_supervised_peft_baseline_wires_common_context_and_artifacts(
    ...
    monkeypatch.setattr(
        "scripts.support.query_ssl_text_encoder.runners.supervised.train_query_peft_classifier",
    ...
    monkeypatch.setattr(
        "scripts.support.query_ssl_text_encoder.runners.supervised.write_run_artifacts",
