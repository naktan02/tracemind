...
def test_run_supervised_lora_baseline_wires_common_context_and_artifacts(
    monkeypatch,
) -> None:
    ...
    monkeypatch.setattr(
        "scripts.experiments.query_peft_ssl.runners.supervised.train_query_lora_classifier",
    ...
    outputs = run_supervised_lora_baseline(
        cfg=_build_cfg(),
